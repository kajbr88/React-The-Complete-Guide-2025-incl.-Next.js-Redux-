...
// useScroll hook helps listen to scroll events and find how far the user scrolled.
// useTransform allows to transform values to values we can use in animation.
...
export default function WelcomePage() {
  ...
  const yText = useTransform(scrollY, [0, 200, 300, 500], [0, 50, 50, 30]);
